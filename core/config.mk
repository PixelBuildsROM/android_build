...
include vendor/pixelbuilds/config/BoardConfigPB.mk
endif
...
ifneq ($(PIXELBUILDS_BUILD),)
ifneq ($(wildcard device/pixelbuilds/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/pixelbuilds/sepolicy/common/sepolicy.mk)
endif
endif
